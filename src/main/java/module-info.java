module es.etg.programacion.mercadaw {
    ...
    opens es.etg.programacion.mercadaw.controller to javafx.fxml;
    ...
    opens es.etg.programacion.mercadaw.trabajador.fol to javafx.fxml;
    opens es.etg.programacion.mercadaw.util to javafx.fxml;
    opens es.etg.programacion.mercadaw.util.printer to javafx.fxml;
    ...
    exports es.etg.programacion.mercadaw.controller;
    ...
    exports es.etg.programacion.mercadaw.trabajador.fol;
    exports es.etg.programacion.mercadaw.util;
    exports es.etg.programacion.mercadaw.util.printer;
