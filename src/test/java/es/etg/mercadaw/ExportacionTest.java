...
public class ExportacionTest{
    ...
    private static Producto p1 = new Cosmetica("Producto", "MarcaDAW", "Cosmetica", 2, 0.3, 0.2, 0.2, 1, "Descripcion breve");
    ...
    @Test
    public void escribirDocumentoTest() throws Exception{
        WriterMarkdown mk = new WriterMarkdown();
        mk.escribir(p1);
    }

    @Test
    public void escribirDocumentosTest()throws Exception{
        WriterMarkdown mk = new WriterMarkdown();
    ...
    @Test
    public void escribirEtiquetaTest()throws Exception{
        WriterMarkdown mk = new WriterMarkdown();
        mk.escribirEtiqueta(p1);
    }

    @Test
    public void exportarDatosDocumentosTest()throws Exception{
    ...
    @Test
    public void exportarDatosEtiquetaTest()throws Exception{
        String esperado = "Success!";
        String real;
        Impresora a = new Impresora();
        mk.escribirEtiqueta(p1);
    ...
    @Test
    public void exportarDatosDocumentoTest()throws Exception{
        String esperado = "Success!";
        String real;
        Impresora a = new Impresora();
        mk.escribir(p1);
    ...
    @Test
    public void exportarDatosNominaTest()throws Exception{
        String esperado = "Success!";
        String real;
        Impresora a = new Impresora();
        mk.escribir(nom);
